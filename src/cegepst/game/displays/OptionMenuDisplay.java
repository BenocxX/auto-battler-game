...
public class OptionMenuDisplay extends Display {
    ...
    public void draw(Buffer buffer) {
        ...
        buffer.drawHorizontallyCenteredText(" Options ", screenRectangle, 80);
    ...
    private void initializeButtonSystem() {
        ...
        menuSystem.addButton(ButtonFactory.backToMainMenuButton(
                CenteringMachine.centerHorizontally(screenRectangle, 200), 280));
